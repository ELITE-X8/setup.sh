...
# ═══════════════════════════════════════════════════════════
# COLORFUL USER MESSAGE ON SSH LOGIN
# ═══════════════════════════════════════════════════════════
force_user_message() {
    local username="$1"
    ...
    # Write colorful ANSI banner to message file
    # Using tput-compatible ANSI codes directly in the file
    {
        printf "\033[1;35m═══════════════════════════════════\033[0m\n"
        printf "\033[1;33m▌\033[1;36m ELITE-X SLOWDNS VPN v5.0         \033[1;33m▐\033[0m\n"
        printf "\033[1;35m═══════════════════════════════════\033[0m\n"
        printf "\033[1;33m USERNAME  \033[0m: \033[1;32m%-24s\033[0m\n" "$username"
        printf "\033[1;34m───────────────────────────────────\033[0m\n"
        printf "\033[1;33m EXPIRE    \033[0m: \033[1;31m%-24s\033[0m\n" "$expire_date"
        printf "\033[1;34m───────────────────────────────────\033[0m\n"
        printf "\033[1;33m REMAINING \033[0m: \033[1;36m%dd + %dhr + %dmin\033[0m\n" \
               "$remaining_days" "$remaining_hours" "$remaining_mins"
        printf "\033[1;34m───────────────────────────────────\033[0m\n"
        printf "\033[1;33m LIMIT GB  \033[0m: \033[1;32m%-24s\033[0m\n" "$bw_display"
        printf "\033[1;33m USAGE GB  \033[0m: \033[1;31m%s GB\033[0m\n" "$usage_gb"
        printf "\033[1;34m───────────────────────────────────\033[0m\n"
        printf "\033[1;33m CONNECTION\033[0m: \033[1;35m%d/%d\033[0m\n" "$current_conn" "$conn_limit"
        printf "\033[1;34m───────────────────────────────────\033[0m\n"
        printf "\033[1;33m STATUS    \033[0m: \033[1;32m%s %s\033[0m\n" "$status_icon" "$status_text"
        printf "\033[1;35m═══════════════════════════════════\033[0m\n"
        printf "\033[1;36m   Thanks for using ELITE-X VPN    \033[0m\n"
        printf "\033[1;35m═══════════════════════════════════\033[0m\n"
        printf "\033[1;32m  SlowDNS | 3Proxy | SOCKS5 | UDP  \033[0m\n"
        printf "\033[1;35m═══════════════════════════════════\033[0m\n\n"
    } > "$msg_file"
